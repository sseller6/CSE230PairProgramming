 ...
 **************************************************/
float computeDistance(float s, float v, float a, float t)
{
 ...
 *     a : acceleration, in meters/second^2
 ***************************************************/
float computeAcceleration(float f, float m) {
 ...
 ***********************************************/
float computeVelocity(float v, float a, float t) {
 ...
 ***********************************************/
float computeVerticalComponent(float a, float total) 
{
 ...
 ***********************************************/
float computeHorizontalComponent(float a, float total)
{
    float x;
    x = sin(a) * total;
    return x;
 ...
 **************************************************/
float convertRadiansToDegrees(float d) {
